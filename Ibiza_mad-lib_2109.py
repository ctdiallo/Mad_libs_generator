...
while True:
    ...
    abstract_noun = input("What caught your attention the most at your arrival: the ...").strip().lower()
    weather_adjective = input("Enter your ideal weather adjective like sunny, snowy... ").strip().lower()
    ...
    verb = input("A verb for your chosen mode of transport: hint..drive, ride, swim ").strip().lower()
        
    ## Story lines are set as variables and include concatenation as well as f-strings
    line_1 = "I travelled to Ibiza by " + transport_mode + ". It was a beautiful and stress free journey. "
